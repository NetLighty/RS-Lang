...
const ChangeThemeButton: FC = () => {
  ...
  return (
    <button onClick={changeTheme} className="change-theme__button" type="button">
      { theme === 'dark' ? (
        <svg
          className="change-theme__img change-theme__img_moon"
          width="24px"
          height="24px"
          viewBox="0 0 24 24"
        ...
        <svg
          className="change-theme__img change-theme__img_sun"
          version="1.1"
          id="Layer_1"
          xmlns="http://www.w3.org/2000/svg"
...
C514.52,263.639,514.496,248.333,504.475,240.259z"
          ...
          <g>
            <g>
              <path d="M165.511,414.528c-1.194-11.097-11.134-19.111-22.255-17.929l-31.211,3.36l3.36-31.211c1.195-11.096-6.833-21.062-17.931-22.257c-11.101-1.2-21.062,6.833-22.257,17.931l-6.044,56.151
